...
SECRET_KEY = 'django-insecure-kj=yn^+st@uel4#56_kc()k7zn=c*l6r2#gy%l41x4-i&bvb46'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [],  # Vacío, ya que usaremos nuestro propio middleware
